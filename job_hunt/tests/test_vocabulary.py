...
def test_the_eligibility_section_holds_market_facts():
    ...
    # No "cities" key, deliberately. City-to-country is reference data,
    # not judgment, and hand-maintaining it was incomplete by
    # construction - it is served by geonamescache in src/scoring/geo.py.
    assert {"countries", "templates", "list_phrases",
